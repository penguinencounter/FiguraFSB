...
public interface VersionedNetworking extends FSBNetworkingService<ServerGamePacketListenerImpl> {
    default void sendVia(@NotNull Consumer<? super net.minecraft.network.protocol.Packet<ClientCommonPacketListener>> consumer, @NotNull Packet<?> packet) {
        ...
        consumer.accept(new ClientboundCustomPayloadPacket(wrapperPayload));
    }
